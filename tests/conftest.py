...
@pytest.fixture
def card_str():
    return ([("12345678901234567890", "**7890"),("1234567890", "**7890"),
             ("12345678", "**5678"),("1234", "**1234"),("123", "**123"),
             ("12", "**12"),("1", "**1"),("", "**"),("1234 5678", "**5678"),("1234-5678", "**5678"),
             ("ABC123", "**B123"),("00001234", "**1234"),("12340000", "**0000"),
])
